...
export const VENUE_INFO: VenueLocation = {
  ...
  parkingInfo: 'Complimentary secure guest parking is available on-site at the Brighton International School campus.',
  transitInfo: 'Located within easy reach of Brighton city centre and Brighton Central Railway Station. Local taxi services are available.',
  nearbyHotels: [
    {
      name: 'The Grand Brighton Hotel',
      distance: '1.2 miles away (5 min drive)',
      discountCode: 'CAROLEJOHN2026',
      website: 'https://example.com/grand-brighton'
    },
    {
      name: 'Brighton Harbour Hotel & Spa',
      distance: '1.0 miles away (5 min drive)',
      discountCode: 'WEDDINGGUEST15',
      website: 'https://example.com/harbour-hotel'
    },
  ]
};

export const GOOGLE_MAPS_URL = `https://www.google.com/maps/search/?api=1&query=${encodeURIComponent('Brighton International School, Brighton BN1 1AA')}`;
export const GOOGLE_MAPS_DIRECTIONS_URL = `https://www.google.com/maps/dir/?api=1&destination=${encodeURIComponent('Brighton International School, Brighton BN1 1AA')}`;
export const APPLE_MAPS_URL = `https://maps.apple.com/?daddr=${encodeURIComponent('Brighton International School, Brighton BN1 1AA')}`;
export const WAZE_URL = `https://waze.com/ul?q=${encodeURIComponent('Brighton International School Brighton BN1 1AA')}&navigate=yes`;
export const EMBEDDED_MAP_IFRAME_URL = `https://maps.google.com/maps?q=${encodeURIComponent('Brighton International School, Brighton')}&t=&z=15&ie=UTF8&iwloc=&output=embed`;
