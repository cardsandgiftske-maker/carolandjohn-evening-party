    ...
    >
      ...
      <div className="relative w-full max-w-lg mx-auto flex flex-col items-center justify-center min-h-[400px] z-10">
        ...
        <div className="text-center mb-6 z-30 animate-fadeIn max-w-md px-2">
          ...
          <h2 className="font-serif text-3xl sm:text-5xl text-rose-50 font-normal tracking-wide drop-shadow-md">
            Carole &amp; John
          </h2>
            ...
            <div className="py-2.5 border-t border-b border-rose-900/40 my-3 grid grid-cols-2 gap-2 text-xs">
              ...
              <div>
                ...
                <a
                  ...
                  className="font-serif text-rose-100 hover:text-amber-300 text-xs font-medium inline-flex items-center space-x-1 group mt-0.5 underline decoration-amber-400/40 hover:decoration-amber-300 transition-colors"
                  title="Open location in Google Maps"
                >
                  <span>{EVENT_DETAILS.venueName}</span>
                  <ExternalLink className="w-3 h-3 text-amber-300 shrink-0 group-hover:scale-110 transition-transform" />
                </a>
              </div>
            </div>
